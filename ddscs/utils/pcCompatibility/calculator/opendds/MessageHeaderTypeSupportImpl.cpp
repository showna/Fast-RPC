/* Generated by opendds_idl.exe version 3.4.1 (ACE version 5.6a_p13) running on input file C:\richi\workspace\desarrollo\DDS\proyectos\rpcdds\idl\MessageHeader.idl*/
...
struct MetaStructImpl<Identification> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    if (std::strcmp(field, "value_1") == 0) {
      ACE_CDR::ULong val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'value_1' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    if (std::strcmp(field, "value_2") == 0) {
      ACE_CDR::ULong val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'value_2' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    if (std::strcmp(field, "value_3") == 0) {
      ACE_CDR::ULong val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'value_3' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    if (std::strcmp(field, "value_4") == 0) {
      ACE_CDR::ULong val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'value_4' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    throw std::runtime_error("Field " + std::string(field) + " not valid for struct Identification");
  }
...
void gen_skip_over(Serializer& ser, Identification*)
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<Identification>().getValue(ser, "");
}
...
struct MetaStructImpl<RequestHeader> : MetaStruct {
  ...
  {
    if (std::strncmp(field, "clientId.", 9) == 0) {
      return getMetaStruct<Identification>().getValue(ser, field + 9);
    } else {
      gen_skip_over(ser, static_cast<Identification*>(0));
    }
    if (std::strcmp(field, "remoteServiceName") == 0) {
      TAO::String_Manager val;
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'remoteServiceName' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'remoteServiceName' length could not be deserialized");
      }
      ser.skip(len);
    }
    if (std::strcmp(field, "requestSequenceNumber") == 0) {
      ACE_CDR::ULong val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'requestSequenceNumber' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    throw std::runtime_error("Field " + std::string(field) + " not valid for struct RequestHeader");
  }
...
void gen_skip_over(Serializer& ser, RequestHeader*)
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<RequestHeader>().getValue(ser, "");
}
...
struct MetaStructImpl<ReplyHeader> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "rpcddsRetCode") == 0) {
      ACE_CDR::Long val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'rpcddsRetCode' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
    ...
    if (std::strcmp(field, "rpcddsRetMsg") == 0) {
      TAO::String_Manager val;
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'rpcddsRetMsg' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'rpcddsRetMsg' length could not be deserialized");
      }
      ser.skip(len);
    }
    if (!field[0]) {
    ...
    throw std::runtime_error("Field " + std::string(field) + " not valid for struct ReplyHeader");
  }
...
void gen_skip_over(Serializer& ser, ReplyHeader*)
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<ReplyHeader>().getValue(ser, "");
}
